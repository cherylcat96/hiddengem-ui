        ...
        <div style={styles.layout}>
          ...
          <main style={styles.main}>
            ...
            <div style={styles.tabs}>
              <button
                style={{ ...styles.tab, ...(tab === 'gems' ? styles.tabActive : {}) }}
                onClick={() => setTab('gems')}
              >
                My Gems ({gems.length})
              </button>
...
function GemCard({ gem, isOwn, onClick, onEdit }) {
  ...
  return (
    <div style={styles.card}>
      <div
        style={{ ...styles.cardImg, background: colors.bg, cursor: 'pointer' }}
        onClick={onClick}
      >
        {gem.cover_photo
...
const styles = {
  ...
  avatar:        { width: '72px', height: '72px', borderRadius: '50%', background: '#1A9E6E', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px', overflow: 'hidden' },
  ...
  profileUsername:{ fontSize: '13px', color: '#9CA3AF', marginBottom: '12px' },
  profileBio:    { fontSize: '13px', color: '#6B7280', lineHeight: '1.6', marginBottom: '16px', textAlign: 'left' },
  statsRow:      { display: 'flex', justifyContent: 'center', gap: '24px', padding: '16px 0', borderTop: '1px solid #F3F4F6', borderBottom: '1px solid #F3F4F6', marginBottom: '16px' },
  stat:          { textAlign: 'center' },
  statNum:       { fontSize: '20px', fontWeight: '700', color: '#111827' },
  statLabel:     { fontSize: '12px', color: '#9CA3AF' },
  profileMeta:   { fontSize: '12px', color: '#9CA3AF', marginBottom: '16px' },
