    ...
    <div style={styles.page}>
      ...
      <nav style={styles.nav}>
        ...
        <div style={styles.navRight}>
          ...
          <button style={styles.navSignUp} onClick={() => navigate('/signup')}>Get Started Free</button>
        </div>
      </nav>
      ...
      <section style={styles.banner}>
        <h2 style={styles.bannerTitle}>Ready to find your next hidden gem?</h2>
...
const styles = {
  ...
  nav:            { height: '60px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 40px', borderBottom: '1px solid #F3F4F6', position: 'sticky', top: 0, background: 'white', zIndex: 10 },
  ...
  navSignUp:      { background: '#1A9E6E', color: 'white', border: 'none', borderRadius: '8px', padding: '8px 16px', fontSize: '14px', fontWeight: '500', cursor: 'pointer' },
  hero:           { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '80px 40px', maxWidth: '1100px', margin: '0 auto', gap: '60px' },
  heroInner:      { flex: 1 },
  ...
  heroTitle:      { fontSize: '48px', fontWeight: '800', color: '#111827', lineHeight: '1.15', margin: '0 0 20px' },
  heroSubtitle:   { fontSize: '17px', color: '#6B7280', lineHeight: '1.7', margin: '0 0 32px', maxWidth: '480px' },
  ...
  how:            { background: '#F9FAFB', padding: '80px 40px' },
  sectionTitle:   { textAlign: 'center', fontSize: '28px', fontWeight: '700', color: '#111827', margin: '0 0 48px' },
  steps:          { display: 'flex', gap: '32px', maxWidth: '900px', margin: '0 auto', justifyContent: 'center' },
  ...
  cats:           { padding: '80px 40px', maxWidth: '1100px', margin: '0 auto' },
  catGrid:        { display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', gap: '12px' },
  ...
  banner:         { background: '#0A6344', padding: '80px 40px', textAlign: 'center' },
  bannerTitle:    { fontSize: '30px', fontWeight: '700', color: 'white', margin: '0 0 12px' },
  ...
  footer:         { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '24px 40px', borderTop: '1px solid #F3F4F6' },
